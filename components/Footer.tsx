        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mt-4">
              Your trusted pool experts. We provide professional pool services
              to keep your pool sparkling clean and running perfectly.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>info@sparklepools.com</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-primary-light mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <span>123 Pool Lane<br />Anytown, USA 12345</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-slate-500 text-sm">
              &copy; {new Date().getFullYear()} Sparkle Pools. All rights reserved.
            </p>
            <p className="text-slate-500 text-sm">
              Licensed &amp; Insured
            </p>
